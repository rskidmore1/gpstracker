...
import TripsReportPage from "./components/TripsReport"; 
import TripsMapPage from "./components/TripsMap"; 
          ...
          <div className="container">
            ...
            <div className="columns">
              <div className="column is-half">
                ...
                <Route exact path="/locationreport" component={LocationPage} />
                <Route exact path="/tripsreport" component={TripsReportPage} />
                <Route exact path="/tripsmap" component={TripsMapPage} />
                </Switch>

  ...
  let menu = (
    <div className="navbar-menu">
      <div className="navbar-start">
        ...
        <Link to="/map" className="navbar-item" data-testid="nav-map">
          Map 
        </Link>
        <Link to="/locationreport" className="navbar-item" data-testid="nav-location-report">
          Location Report 
        </Link>
        <Link to="/tripsreport" className="navbar-item" data-testid="nav-trips-report">
          Trips Report 
        </Link>
      </div>
